...
func BuildInternalRTR(body tk.M, cid string, dealno string) (tk.M, error) {
	...
	for _, val := range exs {
		...
		ar.Set("MaxDPDDAmount", val.GetFloat64("maxDPDInClosedLoanInAmount"))
		ar.Set("AVGDPDDays", CheckNan(val.GetFloat64("maxDPDInClosedLoanInDays")/val.GetFloat64("maxDPDInClosedLoanInAmount")))
