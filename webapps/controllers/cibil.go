...
func (c *DataCapturingController) Cibil(k *knot.WebContext) interface{} {
	...
	k.Config.IncludeFiles = []string{
		...
		"shared/filter.html",
		"shared/loading.html",
		"datacapturing/cibilcomment.html",
		"datacapturing/cibilgrid.html",
		"datacapturing/panelcibil.html",
		"datacapturing/entryreportcibil.html",
	}
...
func (c *DataCapturingController) CibilNew(k *knot.WebContext) interface{} {
	...
	k.Config.IncludeFiles = []string{
		...
		"shared/loading.html",
		"datacapturing/cibilcomment.html",
		"datacapturing/cibilgridnew.html",
		"datacapturing/panelcibilnew.html",
		"datacapturing/entryreportcibil.html",
		"datacapturing/panelcibildetails.html",
		"datacapturing/panelcibilguarantors.html",
		"datacapturing/entryreportcibilnew.html",
	}
