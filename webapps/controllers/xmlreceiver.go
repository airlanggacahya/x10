...
func (c *XMLReceiverController) GetOmnifinData(r *knot.WebContext) interface{} {
	...
	if found && (myStatus == SendBackOmnifin || myStatus == Inque || myStatus == Cancel) {
		globalId = curId
...
func BuildInternalRTR(body tk.M, cid string, dealno string) (tk.M, error) {
	...
	for _, val := range exs {
		ar := tk.M{}
		arb := tk.M{}
		ar.Set("NoActiveLoan", cast.ToF64(val.GetFloat64("noOfActiveLoans"), 2, cast.RoundingAuto))
		ar.Set("AmountOutstandingAccured", cast.ToF64(val.GetFloat64("amountOutstandingAccrued"), 2, cast.RoundingAuto))
		ar.Set("AmountOutstandingDelinquent", cast.ToF64(val.GetFloat64("amountOutstandingDelinquent"), 2, cast.RoundingAuto))
		ar.Set("TotalAmount", cast.ToF64(val.GetFloat64("amountOutstandingAccrued")+val.GetFloat64("amountOutstandingDelinquent"), 2, cast.RoundingAuto))
		ar.Set("NPRDelays", cast.ToF64(val.GetFloat64("noOfPrincipalRepaymentDelays"), 2, cast.RoundingAuto))
		ar.Set("NPREarlyClosures", cast.ToF64(val.GetFloat64("noOfPrincipalRepaymentEarlyClosures"), 2, cast.RoundingAuto))
		ar.Set("NoOfPaymentDueDate", cast.ToF64(val.GetFloat64("noOfPaymentOnDueDate"), 2, cast.RoundingAuto))
		ar.Set("MaxDPDDays", cast.ToF64(val.GetFloat64("maxDPDInClosedLoanInDays"), 2, cast.RoundingAuto))
		ar.Set("MaxDPDDAmount", cast.ToF64(val.GetFloat64("maxDPDInClosedLoanInAmount"), 2, cast.RoundingAuto))
		ar.Set("AVGDPDDays", cast.ToF64(CheckNan(val.GetFloat64("maxDPDInClosedLoanInDays")/val.GetFloat64("maxDPDInClosedLoanInAmount")), 2, cast.RoundingAuto))
		ar.Set("Minimum", cast.ToF64(CheckNan(val.GetFloat64("minimum")), 2, cast.RoundingAuto))
		ar.Set("Average", cast.ToF64(CheckNan(val.GetFloat64("average")), 2, cast.RoundingAuto))
		ar.Set("Maximum", cast.ToF64(CheckNan(val.GetFloat64("maximum")), 2, cast.RoundingAuto))
		...
		arb.Set("TotalLoanAmount", cast.ToF64(CheckNan(val.GetFloat64("sanctionedLimit")), 2, cast.RoundingAuto))
